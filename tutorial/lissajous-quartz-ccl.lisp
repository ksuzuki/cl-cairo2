;;;; -*- Mode: Lisp; Package: lissajous-quartz-ccl -*-
;;;;
;;;; This is a sample code based on 'tiny.lisp' of Clozure CL (thanks!) for
;;;; demonstrating Cairo Quartz surface of cl-cairo2.
;;;;
...
(defpackage :lissajous-quartz-ccl
  (:use :cl :cl-cairo2 :ccl))

(in-package :lissajous-quartz-ccl)
...
(objc:defmethod (#/drawRect: :void) ((self lissajous-view) (rect :<NSR>ect))
  ...
  (let* ((cg-context-ref (#/graphicsPort (#/currentContext ns:ns-graphics-context)))
	...
	;; Translate the coordinate from the Quartz coordinate to the Cairo coordinate.
	(#_CGContextTranslateCTM cg-context-ref 0.0D0 double-height)
	(#_CGContextScaleCTM cg-context-ref 1.0D0 -1.0D0)
	;; Preparation for use of CGFont Helvetica-Bold.
	(with-cstrs ((helvetica-bold "Helvetica-Bold"))
	  (let* ((cfstr-ref (#_CFStringCreateWithCString +null-ptr+ helvetica-bold #$kCFStringEncodingUTF8))
		...
		;;
		;; Draw lissajous using the cl-cairo2 Quartz functions.
		;;
